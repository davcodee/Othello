...
class Tablero {
  ...
  /*
  *Método que nos da las fichas en la misma columna
  */ 
 void mismaColumna(){
 ...
 /*
 * Método que nos da las fichas que están en la misma fila
 */
void mismaFila(){
...
/**
* Método que nos da las fichas que están en la misma diagonal
*/
void enDiagonal(){
